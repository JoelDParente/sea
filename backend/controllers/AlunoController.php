...
switch ($metodo) {
    ...
    case 'POST':
        ...
        if (!$id) { http_response_code(500); echo json_encode(['erro'=>'Falha ao criar aluno']); break; }
    ...
    case 'DELETE':
        ...
        else { $b = json_decode(file_get_contents('php://input'), true); if (isset($b['id_aluno'])) $id = (int)$b['id_aluno']; }
        if (!$id) { http_response_code(400); echo json_encode(['erro'=>'id_aluno ausente']); break; }
